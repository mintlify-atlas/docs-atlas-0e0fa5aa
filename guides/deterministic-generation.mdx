---
title: "Deterministic Generation with Seeded Random"
...
## Setting a Locale Alongside a Seed

The second constructor parameter, `locale`, controls culture-sensitive formatting (e.g., title casing, date formatting). You can combine both a seed and a locale:
