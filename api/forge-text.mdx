---
title: "ForgeText: String, GUID, and Hex Generators for Forged"
sidebarTitle: "Text"
description: "ForgeText (f.Text) provides generators for strings, GUIDs, hex values, Lorem ipsum filler, pronounceable words, templates, and waffle text."
---
