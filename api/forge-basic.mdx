---
title: "ForgeBasic: Literal Values and Function Generators"
sidebarTitle: "Basic"
description: "ForgeBasic (f.Basic) provides two foundational generators: Literal<T> for fixed constant values and Func<T> for delegate-based custom lambdas."
---
